...
public class StuffDetailActivity extends AppCompatActivity {
    private StuffDetailPresenter mStuffDetailPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Fragment
        StuffDetailFragment stuffDetailFragment = (StuffDetailFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
        if(stuffDetailFragment == null) {
            stuffDetailFragment = StuffDetailFragment.newInstance();
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), stuffDetailFragment, R.id.contentFrame);
        }
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MyApplication.getContext());
        String userId = sharedPreferences.getString("USERID", null);
        AppExecutors appExecutors = new AppExecutors();

        String stuffid = getIntent().getStringExtra("STUFFID");
        //presenter
        mStuffDetailPresenter = new StuffDetailPresenter(
                ...
                stuffDetailFragment, userId, stuffid);
        ...
        mListNameTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //加载dialog对话框
                mStuffDetailPresenter.showLists();
            }
        });
    }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.calendar_navigation_menu_item:
                        Intent intent3 = new Intent(StuffDetailActivity.this, CalendarActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.allStuff_navigation_menu_item:
                        Intent intent2 = new Intent(StuffDetailActivity.this, AllStuffActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.listGroup_navigation_menu_item:
                        Intent intent = new Intent(StuffDetailActivity.this, ListGroupActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.notifications_navigation_menu_item:
                        Intent intent1 = new Intent(StuffDetailActivity.this, NotificationActivity.class);
