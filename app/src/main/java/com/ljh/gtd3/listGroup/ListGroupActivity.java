...
public class ListGroupActivity extends AppCompatActivity {
    ...
    private ListGroupPresenter mListGroupPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListGroupFragment listGroupFragment = (ListGroupFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
        if(listGroupFragment == null) {
            listGroupFragment = ListGroupFragment.newInstance();
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), listGroupFragment, R.id.contentFrame);
        }

        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MyApplication.getContext());
        String userId = sharedPreferences.getString("USERID", null);
        AppExecutors appExecutors = new AppExecutors();
        mListGroupPresenter = new ListGroupPresenter(
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.calendar_navigation_menu_item:
                        Intent intent3 = new Intent(ListGroupActivity.this, CalendarActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.allStuff_navigation_menu_item:
                        Intent intent2 = new Intent(ListGroupActivity.this, AllStuffActivity.class);
                    ...
                    case R.id.notifications_navigation_menu_item:
                        Intent intent1 = new Intent(ListGroupActivity.this, NotificationActivity.class);
