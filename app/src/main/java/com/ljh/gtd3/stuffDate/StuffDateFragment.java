...
public class StuffDateFragment extends Fragment implements StuffDateContract.View {
    private static final String TAG = StuffDateFragment.class.getSimpleName();
    private StuffDateContract.Presenter mPresenter;
    ...
    public static StuffDateFragment newInstance() {
        StuffDateFragment fragment = new StuffDateFragment();
        return fragment;
    }
    ...
    @Override
    public void setPresenter(StuffDateContract.Presenter presenter) {
